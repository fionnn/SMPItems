...
public class Command_smpcredits extends SBase implements CommandExecutor
{
    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
    {
        sender.sendMessage(String.format(SUtil.color("&3&oSMPItems v%s"), plugin.getDescription().getVersion()));
